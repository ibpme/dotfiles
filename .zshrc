...
export PATH="/home/ibpme/.local/bin:$PATH"
...
source ~/Source/z/z.sh
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/ibpme/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/ibpme/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/ibpme/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ibpme/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
